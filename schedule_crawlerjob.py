...
if __name__ == '__main__':
    schedule.every().day.at('19:57').do(job1_task)
    schedule.every().day.at('20:00').do(job2_task)
    schedule.every().day.at('20:00').do(job3_task)
    schedule.every().day.at('20:00').do(job4_task)
    while True:
