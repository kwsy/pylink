...
if __name__ == '__main__':
    schedule.every().day.at('14:40').do(job1_task)
    schedule.every().day.at('14:50').do(job2_task)
    schedule.every().day.at('14:50').do(job3_task)
    schedule.every().day.at('14:50').do(job4_task)
    while True:
