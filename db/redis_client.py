...
def test():
    ...
    lpush_queue(redis_conf.QueueConfig.csdn_queue, 'test queue2')
    lpush_queue(redis_conf.QueueConfig.csdn_queue, 'test queue3')
    # print(connect_redis.rpop(redis_conf.QueueConfig.csdn_queue))    # 按输入顺序，每次只取一条，先入先出
    print(rpop_queue(redis_conf.QueueConfig.csdn_queue))
